...
def test_health_check_passes_with_200_response_code(
    mock_requests_get_happy_path,
):
...
def test_health_check_fails_with_bad_response_code(mock_requests_get_sad_path):
